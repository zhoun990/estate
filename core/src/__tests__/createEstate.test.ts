...
describe("createEstate", () => {
  ...
  describe("persistence", () => {
    ...
    it("should save data to localStorage on updates", async () => {
      ...
      const initialCallCount = (global as any).localStorageMock.setItem.mock
        .calls.length;
      ...
      const finalCallCount = (global as any).localStorageMock.setItem.mock.calls
        .length;
  ...
  describe("subscriptions", () => {
    ...
    it("should unsubscribe from value changes", async () => {
      ...
      const unsubscribe = estate.subscribe(
        "user",
        "name",
        "test-listener",
        callback
