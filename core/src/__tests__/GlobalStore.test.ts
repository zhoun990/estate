...
describe('GlobalStore', () => {
  ...
  describe('store operations', () => {
    ...
    it('should get cloned values', async () => {
      ...
      const testStore = GlobalStore.getInstance({ test: { data: originalValue } });
  ...
  describe('setValue', () => {
    it('should update single value', async () => {
      store.setValue('user', 'name', async () => 'Jane');
    ...
    it('should handle async value updates', async () => {
      store.setValue('user', 'age', async (current) => current + 1);
      await new Promise(resolve => setTimeout(resolve, 0));
  ...
  describe('subscriptions', () => {
    ...
    it('should handle once subscription', async () => {
      ...
      store.setValue('user', 'name', async () => 'Bob');
      await new Promise(resolve => setTimeout(resolve, 0));
  ...
  describe('middleware', () => {
    it('should apply middleware to value updates', async () => {
    ...
    it('should apply multiple middlewares', async () => {
      ...
      store.setValue('user', 'name', async () => 'jane');
      store.setValue('user', 'age', async () => 25);
      await new Promise(resolve => setTimeout(resolve, 0));
